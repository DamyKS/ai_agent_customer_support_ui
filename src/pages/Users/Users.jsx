...
import { Search, Plus, MoreHorizontal, User, Mail, Shield, Activity } from "lucide-react"
...
const statuses = ["active", "offline", "busy"]
    ...
    <div className="flex flex-1 flex-col gap-4 p-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage support agents and administrators</p>
        </div>
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Create a new user account for your support team</DialogDescription>
            </DialogHeader>
            ...
            <TableBody>
              {filteredUsers.map((user) => (
                <TableRow key={user.id}>
                  ...
                  <TableCell>
                    <Badge
                      variant={user.status === "active" ? "default" : user.status === "busy" ? "secondary" : "outline"}
                    >
                      {user.status}
                    </Badge>
                  </TableCell>
                  <TableCell className="text-muted-foreground">{user.lastActive}</TableCell>
                  <TableCell>{user.chatsHandled}</TableCell>
